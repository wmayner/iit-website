...
(function() {
  var CSVReporter, CheckstyleReporter, CoffeeScript, ErrorReport, JSLintReporter, Reporter, coffeelint, config, configfinder, data, errorReport, findCoffeeScripts, fs, getFallbackConfig, glob, lintFiles, lintSource, loadRules, optimist, options, path, paths, read, reportAndExit, ruleName, scripts, stdin, thisdir, _ref, _ref1, _ref2,
    __slice = [].slice,
  ...
  CheckstyleReporter = (function(_super) {
    ...
    CheckstyleReporter.prototype.publish = function() {
      var context, e, errors, _i, _len, _ref3, _ref4;
  ...
  lintFiles = function(paths, config) {
    var errorReport, fileConfig, literate, source, _i, _len;
    ...
    for (_i = 0, _len = paths.length; _i < _len; _i++) {
      ...
      fileConfig = config ? config : getFallbackConfig(path);
